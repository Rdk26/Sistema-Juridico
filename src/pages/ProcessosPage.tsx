...
export default function ProcessosPage() {
  return (
    <main className="flex-1 overflow-auto p-6">
      <h1 className="text-3xl font-bold mb-8 texto-escuro">Processos</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        <div className="card-juridico p-6">
          ...
          <p className="text-4xl text-primary font-semibold mt-2 dark:text-white">24</p>
        </div>
        
        <div className="card-juridico p-6">
          <h3 className="texto-escuro text-lg font-semibold">Prazo Médio</h3>
          <p className="text-4xl text-primary font-semibold mt-2 dark:text-white">45 dias</p>
        </div>
        
        <div className="card-juridico p-6">
          <h3 className="texto-escuro text-lg font-semibold">Taxa de Sucesso</h3>
          <p className="text-4xl text-primary font-semibold mt-2 dark:text-white">82%</p>
        </div>
      </div>
    </main>
  );
